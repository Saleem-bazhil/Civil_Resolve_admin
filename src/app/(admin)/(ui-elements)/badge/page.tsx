...
export const metadata: Metadata = {
  title: "Next.js Badge | Bazhil Civil Resolve - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Bazhil Civil Resolve - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
