...
export const metadata: Metadata = {
  title: "Next.js Buttons | Bazhil Civil Resolve - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Bazhil Civil Resolve - Next.js Tailwind CSS Admin Dashboard Template",
};
