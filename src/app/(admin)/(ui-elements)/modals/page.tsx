...
export const metadata: Metadata = {
  title: "Next.js Modals | Bazhil Civil Resolve - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Bazhil Civil Resolve - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
