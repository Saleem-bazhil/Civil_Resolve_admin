...
export const metadata: Metadata = {
  title: "Next.js Avatars | Bazhil Civil Resolve - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Bazhil Civil Resolve - Next.js Tailwind CSS Admin Dashboard Template",
};
